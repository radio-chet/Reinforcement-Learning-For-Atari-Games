...
agent.restore("./pong/A2C/A2C_PongNoFrameskip-v4_320a8_00000_0_2022-04-23_16-27-41/checkpoint_001950/checkpoint-1950")
...
env = RecordVideo(env = gym.make("PongNoFrameskip-v4"), video_folder="./pong_video/A2C/")
