...
agent.restore("./pong/A3C/A3C_PongNoFrameskip-v4_52d18_00000_0_2022-04-24_02-22-44/checkpoint_011500/checkpoint-11500")
...
env = RecordVideo(env = gym.make("PongNoFrameskip-v4"), video_folder="./pong_results/A3C/")
...
# The above restoration worked fine and also the logs in tensorboard started from the last checkpoint time step